...
test "kindergarten queen move generation" {
    ...
    const testCases = [_]struct {
        ...
        .{
            .square = Square.from_idx(27) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(44101632010312),
        },
        .{
            .square = Square.from_idx(26) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(4620711970483343648),
        },
        .{
            .square = Square.from_idx(28) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(113245540908029074),
        },
        .{
            .square = Square.from_idx(36) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(4565637075832848),
        },
        .{
            .square = Square.from_idx(44) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(4915723215677034768),
        },
        .{
            .square = Square.from_idx(3) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(9381436070935),
        },
        .{
            .square = Square.from_idx(49) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(512573672425275520),
        },
        .{
            .square = Square.from_idx(63) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(9205534112117457024),
        },
        .{
            .square = Square.from_idx(7) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(9332167099941961840),
        },
        .{
            .square = Square.from_idx(13) orelse unreachable,
            .occupancy = Bitboard.fromInt(4547872720945168),
            .expected = Bitboard.fromInt(20005838704),
        },
    };
